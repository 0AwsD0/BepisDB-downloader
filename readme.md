...
## You can use simpler version of the program or usage advanced one.
Advanced program allows you to control its behavior more and edit its configuration.
For most users the standard one is enough.
The advanced program version is inside 'advanced_version' Dir in this repository.
